...
//        只有一个小程序的时候，WxMaConfigHolder也用不到，所以不需要switchover，看cn.binarywang.wx.miniapp.api.impl.BaseWxMaServiceImpl.getWxMaConfig
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(WxPortalController.class);
}
